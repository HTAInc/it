...
export default function Index({auth,sections, flashMessage}) {
    ...
    const handleEdit = (id) => {
        get(route('admin.section.edit',id));
    }
    ...
    function handleDelete(id) {
        Swal.fire({
            ...
            if (result.isDenied) {
                destroy(route('admin.section.destroy',id))
            }
        });
    };
        ...
        <Authenticated user={auth.user}>
            ...
            <div className="w-full">
                <div className="flex justify-between mb-3">
                    <Link href={route('admin.section.create')} className="bg-rose-500 hover:bg-rose-600 focus:bg-rose-600 active:bg-rose-600 focus:ring-rose-500">
