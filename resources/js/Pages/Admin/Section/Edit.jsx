...
export default function create({auth,section,departments}) {
    ...
    const submit = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                put(route(`admin.section.update`,section.id),{
                    _method: 'PUT',
                    ...data
                });
            }
        ...
        <Authenticated user={auth.user}>
            ...
            <div className="flex justify-center">
                <form onSubmit={submit} className="bg-white w-full md:w-96 shadow-md rounded-md flex flex-col overflow-hidden">
                    <div className="w-full px-5 py-2 font-semibold text-rose-600 border-b">Edit Section : {section.name}</div>
                    <div className="p-5">
                        <div className="mb-5">
